...
## Project-Specific: Scientific Constants

- Every pharmacokinetic constant (half-life, threshold, extraction yield) must have a test verifying its value with a comment citing the source paper.
- Bug fixes for calculations start with a regression test reproducing the incorrect output.
